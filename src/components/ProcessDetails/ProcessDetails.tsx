...
export const ProcessDetails: FunctionComponent<IProcessDetailsProps> = (
  props
) => {
  return (
    <div className="process-details">
      ...
      <Row className="mb-2">
        ...
        <Col md="7" sm="12" xs="12">
          {props.process.SBPControlNumber
            ? props.process.SBPControlNumber
            : "None"}
        </Col>
      </Row>
      ...
      {props.process.ProcessType === ProcessTypes.DD2579 && (
        <Row>
          <Col md="5" sm="12" xs="12">
