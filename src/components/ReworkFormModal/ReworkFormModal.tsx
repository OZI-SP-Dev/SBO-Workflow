...
export const ReworkFormModal: FunctionComponent<ReworkFormModalProps> = (
  props
) => {
  ...
  const submitForm = async () => {
    ...
    if (
      ...
      await props.submit(
        nextStage,
        assignee,
        "<strong>Rework Reason: " + reworkReason + "</strong><br/>" + noteText
      );
      closeForm();
    }
  };
  ...
  return (
    ...
    >
      <Form>
        <Form.Group controlId="reworkFormPersonSelect">
          <Form.Label className="required">
            <strong>
              {nextStage === Stages.BUYER_REVIEW ? "Buyer:" : "Reviewer:"}
            </strong>
          </Form.Label>
          <Form.Control
            as={PeoplePicker}
        ...
        <Form.Group controlId="reworkFormReason">
          ...
          >
            <option value={""}>--</option>
            {Object.values(ReworkReasons).map((reason) => (
        ...
        <Form.Group controlId="reworkFormNotes">
          <div className="mb-2">
            <Form.Label className="mt-2 required">
          ...
          <Form.Control
            className="invisible"
            isInvalid={submitAttempted && !noteText}
          />
